...
namespace ERPSYS.Reports.Est
{
    ...
    /// <summary>
    /// Summary description for QuoteCompact.
    /// </summary>
    public partial class QuoteCompact : Telerik.Reporting.Report
    {
        public QuoteCompact()
        {
            //
        ...
        private void QuoteCompact_ItemDataBound(object sender, EventArgs e)
        {
            ...
            //int companyId = ((Telerik.Reporting.Processing.TextBox)rpt.ChildElements.Find("txtCompanyId", true)[0]).Value.ToInt();
            //int currencyId = ((Telerik.Reporting.Processing.TextBox)rpt.ChildElements.Find("txtCurrencyId", true)[0]).Value.ToInt();
            //decimal grandTotal = ((Telerik.Reporting.Processing.TextBox)rpt.ChildElements.Find("txtGrandTotal", true)[0]).Value.ToDecimal();
