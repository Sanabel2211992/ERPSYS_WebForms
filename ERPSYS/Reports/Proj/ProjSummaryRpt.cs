...
namespace ERPSYS.Reports.Proj
{
    ...
    public partial class ProjSummaryRpt : Telerik.Reporting.Report
    {
        public ProjSummaryRpt()
        {
            //
        ...
        private void ProjSummaryRpt_ItemDataBound(object sender, EventArgs e)
        {
            ...
            //decimal netprofit = ((Telerik.Reporting.Processing.TextBox)Telerik.Reporting.Processing.ElementTreeHelper.FindChildByName(rpt, "txtNetprofitTotal", true)[0]).Value.ToDecimal();
