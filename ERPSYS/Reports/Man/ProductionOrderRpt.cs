...
namespace ERPSYS.Reports.Man
{
    ...
    public partial class ProductionOrderRpt : Telerik.Reporting.Report
    {
        public ProductionOrderRpt()
        {
            //
        ...
        private void ProductionOrderRpt_ItemDataBound(object sender, EventArgs e)
        {
