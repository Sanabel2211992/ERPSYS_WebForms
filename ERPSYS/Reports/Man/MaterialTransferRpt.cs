...
namespace ERPSYS.Reports.Man
{
    ...
    public partial class MaterialTransferRpt : Telerik.Reporting.Report
    {
        public MaterialTransferRpt()
        {
            //
        ...
        private void MaterialTransferRpt_ItemDataBound(object sender, EventArgs e)
        {
