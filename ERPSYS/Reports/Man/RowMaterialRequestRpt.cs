...
namespace ERPSYS.Reports.Man
{
    ...
    public partial class RowMaterialRequestRpt : Telerik.Reporting.Report 
    {
        public RowMaterialRequestRpt()
        {
            InitializeComponent();
        }

        private void RowMaterialRequestRpt_ItemDataBound(object sender, EventArgs e)
        {
