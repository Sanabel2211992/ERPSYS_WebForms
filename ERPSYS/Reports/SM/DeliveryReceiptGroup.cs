...
namespace ERPSYS.Reports.SM
{
    ...
    public partial class DeliveryReceiptGroup : Telerik.Reporting.Report
    {
        public DeliveryReceiptGroup()
        {
            //
        ...
        private void DeliveryReceiptGroup_ItemDataBound(object sender, EventArgs e)
        {
