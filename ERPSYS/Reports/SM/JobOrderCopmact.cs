...
namespace ERPSYS.Reports.SM
{
    ...
    public partial class JobOrderCopmact : Telerik.Reporting.Report
    {
        public JobOrderCopmact()
        {
            //
        ...
        private void JobOrderCopmact_ItemDataBound(object sender, EventArgs e)
        {
