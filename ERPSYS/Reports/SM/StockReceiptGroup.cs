...
namespace ERPSYS.Reports.SM
{
    ...
    public partial class StockReceiptGroup : Telerik.Reporting.Report
    {
        public StockReceiptGroup()
        {
            //
        ...
        private void StockReceiptGroup_ItemDataBound(object sender, EventArgs e)
        {
