...
namespace ERPSYS.Helpers.Ext
{
    public static class StringExtensions
    {
        ...
        public static string ReplaceWhenNullOrEmpty(this string value, string replaceWith)
        {
        ...
        public static string ReplaceDateWhenNullOrEmpty(this DateTime value, string replaceWith)
        {
            return value.ToShortDateString() == "1/1/0001" ? replaceWith : value.ToShortDateString();
        }

        public static string AppendTimeStamp(this string fileName)
        {
            return string.Concat(Path.GetFileNameWithoutExtension(fileName), "_", DateTime.Now.ToString("yyyyMMddHHmmssfff"), Path.GetExtension(fileName));
        }
