<%@ Page Title="" Language="C#" MasterPageFile="~/ERP/Main.Master" AutoEventWireup="true" CodeBehind="ticket-department-form.aspx.cs" Inherits="ERPSYS.ERP.settings.ticket_department_form" %>
        ...
        <tr>
            <td>
                <fieldset class="fs-edit">
                    <legend class="fs-inner-legend">Department Information</legend>
                    <table class="tbl-edit" style="width: 900px">
                        ...
                        <tr>
                            ...
                            <td class="fv-edit" colspan="3">
                                ...
                                <asp:RequiredFieldValidator ID="rfvDepartmentName" runat="server" ControlToValidate="txtDepartmentName" ValidationGroup="save" ErrorMessage="*" CssClass="val-error" Display="Dynamic"></asp:RequiredFieldValidator>
                            </td>
                            <td class="ft-edit"></td>
                            <td class="fv-edit"></td>
                        </tr>
                        <tr>
                            ...
                            <td class="fv-edit" colspan="3">
                                <asp:TextBox ID="txtDescription" runat="server" Height="50px" TextMode="MultiLine" Width="450px"></asp:TextBox>
                            </td>
                            <td class="ft-edit"></td>
                            <td class="fv-edit"></td>
                        </tr>
