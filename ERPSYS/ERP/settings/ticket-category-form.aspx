<%@ Page Title="" Language="C#" MasterPageFile="~/ERP/Main.Master" AutoEventWireup="true" CodeBehind="ticket-category-form.aspx.cs" Inherits="ERPSYS.ERP.settings.ticket_category_form" %>
        ...
        <tr>
            <td>
                <fieldset class="fs-edit">
                    <legend class="fs-inner-legend">Category Information</legend>
                    <table class="tbl-edit" style="width: 900px">
                        ...
                        <tr>
                            ...
                            <td class="fv-edit" colspan="3">
                                ...
                                <asp:RequiredFieldValidator ID="rfvCategoryName" runat="server" ControlToValidate="txtCategoryName" ValidationGroup="save" ErrorMessage="*" CssClass="val-error" Display="Dynamic"></asp:RequiredFieldValidator>
                            </td>
                            <td class="ft-edit"></td>
                            <td class="fv-edit"></td>
                        </tr>
