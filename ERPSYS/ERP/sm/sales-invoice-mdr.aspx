<%@ Page Title="" Language="C#" MasterPageFile="~/ERP/Main.Master" AutoEventWireup="true" CodeBehind="sales-invoice-mdr.aspx.cs" Inherits="ERPSYS.ERP.sm.SalesInvoiceMDR" %>
            ...
            <tr>
                <td>
                    <fieldset class="fs-view">
                        <legend class="fs-view-legend">Delivery Receipts Information</legend>
                        <table class="tbl-view" style="width: 600px">
                            <tr>
                                <th class="ft-view" style="width: 125px"></th>
                                <th class="fv-view" style="width: 475px"></th>
                            </tr>
                            <tr>
                            ...
                            <asp:Panel ID="pnlDeliveryReceipt" Visible="False" runat="server">
                                <tr>
                                    <td class="ft-view">Delivery Receipts :</td>
                                    <td class="fv-view">
            ...
            <tr>
                <td>
                    <fieldset class="fs-view">
                        ...
                        <div class="multi-dlvry-pos">
                            <telerik:RadListBox ID="rlbDeliveryReceipts" runat="server" Height="225px" Width="150px"></telerik:RadListBox>
                        </div>
                    </fieldset>
                </td>
            </tr>
