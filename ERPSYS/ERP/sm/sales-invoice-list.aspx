<%@ Page Title="" Language="C#" MasterPageFile="~/ERP/Main.Master" AutoEventWireup="true" CodeBehind="sales-invoice-list.aspx.cs" Inherits="ERPSYS.ERP.sm.SalesInvoiceList" %>
            ...
            <td>
                <fieldset class="fs-search">
                    ...
                    <table class="tbl-search" style="width: 900px">
                        ...
                        <tr>
                            <td class="ft-search">Sales Invoice # :</td>
                            <td class="fv-search" colspan="5">
            ...
            <MasterTableView ShowHeadersWhenNoRecords="true">
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderStyle-Width="20px">
                        <ItemTemplate>
                            <div>
                                <a href='<%# string.Format("sales-invoice-preview.aspx?id={0}", Eval("InvoiceId")) %>'>
                    ...
                    <telerik:GridBoundColumn DataField="CustomerName" HeaderText="Customer Name" HeaderStyle-Width="525px" />
                    <telerik:GridBoundColumn DataField="Location" HeaderText="Location" HeaderStyle-Width="150px" />
                    <telerik:GridDateTimeColumn DataField="InvoiceDate" HeaderText="Invoice Date" DataType="System.DateTime" DataFormatString="{0:dd/MM/yyyy}" HeaderStyle-Width="110px" />
                    <telerik:GridBoundColumn DataField="GrandTotal" HeaderText="Invoice Total" HeaderStyle-Width="125px" DataFormatString="{0:N}" />
