<%@ Page Title="" Language="C#" MasterPageFile="~/ERP/Main.Master" AutoEventWireup="true" CodeBehind="delivery-receipt-list.aspx.cs" Inherits="ERPSYS.ERP.sm.DeliveryReceiptList" %>
...
<asp:Content ID="cHeader" ContentPlaceHolderID="cphHeader" runat="server">
    <script type="text/javascript">
        ...
        function ClearFields() {
            ...
            $('#<%= txtDeliveryReceiptNumber.ClientID %>').val("");
...
<asp:Content ID="cMian" ContentPlaceHolderID="cphMain" runat="server">
            ...
            <td>
                <fieldset class="fs-search">
                    ...
                    <table class="tbl-search" style="width: 600px">
                        ...
                        <tr>
                            <td class="ft-search">Delivery Receipt # :</td>
                            <td class="fv-search" colspan="3">
                                <asp:TextBox ID="txtDeliveryReceiptNumber" runat="server" Width="350px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
    ...
    <div>
        <telerik:RadToolBar ID="rtbOperations" runat="server" CssClass="tb-main" RenderMode="Lightweight" EnableRoundedCorners="True" EnableShadows="True" SingleClick="None" Width="100%" EnableImageSprites="True" OnButtonClick="rtbOperations_ButtonClick" Skin="Metro">
            <Items>
                <%--<telerik:RadToolBarButton runat="server" CommandName="add" Text="Create Sales Invoice" ImageUrl="~/ERP/resources/images/toolbar/ico_new.png" Width="150px" />--%>
    ...
    <div class="grid-container no-bg">
        <telerik:RadGrid ID="rgDeliveryReceiptList" runat="server" RenderMode="Lightweight" ShowFooter="true" AllowPaging="True" AllowSorting="False" AutoGenerateColumns="False" OnNeedDataSource="rgDeliveryReceiptList_NeedDataSource" OnInit="rgDeliveryReceiptList_Init" OnItemDataBound="rgDeliveryReceiptList_ItemDataBound">
            <MasterTableView ShowHeadersWhenNoRecords="true">
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderStyle-Width="20px">
                        <ItemTemplate>
                            <div>
                                <a href='<%# string.Format("delivery-receipt-preview.aspx?id={0}", Eval("ReceiptId")) %>'>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Receipt #" HeaderStyle-Width="125px">
                        <ItemTemplate>
                            <div>
                                <a class="grdlink" href='<%# string.Format("delivery-receipt-preview.aspx?id={0}", Eval("ReceiptId")) %>'><%# Eval("ReceiptNumber") %></a>
                            </div>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                    ...
                    <telerik:GridBoundColumn DataField="SalesOrderNumber" HeaderText="Order #" HeaderStyle-Width="125px" />
                    <telerik:GridBoundColumn DataField="InvoiceNumber" HeaderText="Invoice #" HeaderStyle-Width="125px" />
    ...
    <telerik:RadAjaxManager ID="raManager" runat="server">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="btnSearch">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="rgDeliveryReceiptList" UpdatePanelCssClass="" LoadingPanelID="lpLoading" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="rgDeliveryReceiptList">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="rgDeliveryReceiptList" UpdatePanelCssClass="" LoadingPanelID="lpLoading" />
                </UpdatedControls>
            </telerik:AjaxSetting>
