<%@ Page Title="" Language="C#" MasterPageFile="~/ERP/Main.Master" AutoEventWireup="true" CodeBehind="sales-invoice-form.aspx.cs" Inherits="ERPSYS.ERP.sm.SalesInvoiceForm" %>
            ...
            <td>
                <fieldset class="fs-edit">
                    ...
                    <table class="tbl-edit" style="width: 900px">
                        ...
                        <tr>
                            <td class="ft-edit" style="width: 125px">Sales Invoice # :</td>
                ...
                <div>
                    <asp:Button ID="btnUpdate" runat="server" Text="Update" CssClass="fs-edit btn-save btn-save-sm-si" ValidationGroup="save"
                        OnClientClick="if (typeof(Page_ClientValidate) == 'function') { Page_ClientValidate('save'); if(Page_IsValid) { return confirm('Are you sure you want to save the Invoice Information ?'); } else return;};"
            ...
            <td>
                <div class="grid-container no-bg">
                    ...
                    <telerik:RadGrid ID="rgSalesInvoice" runat="server" ShowStatusBar="true" AutoGenerateColumns="False" GridLines="None"
                        ...
                        OnDetailTableDataBind="rgSalesInvoice_DetailTableDataBind" OnItemCommand="rgSalesInvoice_ItemCommand"
                        OnInsertCommand="rgSalesInvoice_InsertCommand" OnUpdateCommand="rgSalesInvoice_UpdateCommand"
                        OnNeedDataSource="rgSalesInvoice_NeedDataSource" OnPreRender="rgSalesInvoice_PreRender" OnDeleteCommand="rgSalesInvoice_DeleteCommand" OnItemCreated="rgSalesInvoice_ItemCreated" OnItemDataBound="rgSalesInvoice_ItemDataBound">
                            ...
                            <DetailTables>
                                <telerik:GridTableView DataKeyNames="ParentId,LineId,ItemId" Name="SubItems"
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="ItemCode" HeaderText="Catalog No" HeaderStyle-Width="150px" />
                                        ...
                                        <telerik:GridBoundColumn DataField="UnitPrice" HeaderText="Price" DataFormatString="{0:N}" HeaderStyle-Width="100px" />
                                        ...
                                        <telerik:GridBoundColumn DataField="NetPrice" HeaderText="Net Price" DataFormatString="{0:N}" HeaderStyle-Width="100px" />
