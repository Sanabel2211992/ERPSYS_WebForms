<%@ Page Title="" Language="C#" MasterPageFile="~/ERP/Main.Master" AutoEventWireup="true" CodeBehind="sales-order-quote.aspx.cs" Inherits="ERPSYS.ERP.sm.SalesOrderQuote" %>
            ...
            <td>
                <fieldset class="fs-view">
                    ...
                    <table class="tbl-view" style="width: 1160px">
                        ...
                        <tr>
                            <td class="ft-view">Quote Number :</td>
                            <td class="fv-view">
                ...
                <fieldset class="fs-edit">
                    ...
                    <table class="tbl-edit" style="width: 1160px">
                        ...
                        <tr>
                            ...
                            <td class="fv-edit">
                                <asp:TextBox ID="txtCustomerPO" runat="server" Width="150px"></asp:TextBox>
                            </td>
        ...
        <tr>
            <td class="center-btn">
                <table class="tbl-op-center" style="width: 200px">
                    <tr>
                        <td>
                            <asp:Button ID="btnSave" runat="server" Text="Create Order" Width="135px" CssClass="btn-op"
                                OnClientClick="if (typeof(Page_ClientValidate) == 'function') { Page_ClientValidate('save'); if(Page_IsValid) { return confirm('Are you sure you want to create Sales Order ?'); } else return;};"
