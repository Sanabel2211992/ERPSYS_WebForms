<%@ Page Title="" Language="C#" MasterPageFile="~/ERP/Main.Master" AutoEventWireup="true" CodeBehind="goods-production-store.aspx.cs" Inherits="ERPSYS.ERP.inventory.goods_production_store" %>
        ...
        <tr>
            <td>
                <table class="tbl-grid">
                    <tr>
                        <td>
                            <telerik:RadGrid ID="rgProductionItemsList" runat="server" RenderMode="Lightweight" ShowFooter="true" AllowPaging="True" AllowSorting="False" Width="100%" AutoGenerateColumns="False" OnNeedDataSource="rgProductionItemsList_NeedDataSource" OnInit="rgProductionItemsList_Init">
                                <MasterTableView ShowHeadersWhenNoRecords="true">
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridTemplateColumn HeaderStyle-Width="20px">
                                            <ItemTemplate>
                                                <div>
                                                    <%--<a href='<%# string.Format("goods-production-store-details.aspx?id={0}", Eval("ItemId")) %>'>--%>
                                                    <img src="../../Controls/resources/images/ico_search_16_16.gif" alt="production Order" style="border: 0" />
                                                    <%-- </a>--%>
                                                </div>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        ...
                                        <telerik:GridBoundColumn DataField="UOM" HeaderText="UOM" DataFormatString="{0:F2}" HeaderStyle-Width="75px" />
    ...
    <telerik:RadAjaxManager ID="raManager" runat="server">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="btnSearch">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="rgProductionItemsList" UpdatePanelCssClass="" LoadingPanelID="lpLoading" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="rgProductionItemsList">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="rgProductionItemsList" UpdatePanelCssClass="" LoadingPanelID="lpLoading" />
                </UpdatedControls>
            </telerik:AjaxSetting>
