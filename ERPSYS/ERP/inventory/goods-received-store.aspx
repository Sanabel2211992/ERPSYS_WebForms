<%@ Page Title="" Language="C#" MasterPageFile="~/ERP/Main.Master" AutoEventWireup="true" CodeBehind="goods-received-store.aspx.cs" Inherits="ERPSYS.ERP.inventory.GoodsReceivedStore" %>
            ...
            <MasterTableView ShowHeadersWhenNoRecords="true">
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderStyle-Width="20px">
                        <ItemTemplate>
                            <div>
                                <a href='<%# string.Format("goods-received-store-details.aspx?id={0}", Eval("ItemId")) %>'>
