<%@ Page Title="" Language="C#" MasterPageFile="~/Controls/DialogBox/Dialog.Master" AutoEventWireup="true" CodeBehind="ItemSearch.aspx.cs" Inherits=" ERPSYS.ERP.t.ItemSearch" %>
                ...
                <table class="tbl-inner" style="width: 800px">
                    ...
                    <tr>
                        ...
                        <td class="field-title">
                            <asp:DropDownList ID="ddlLocationGet" runat="server" Width="150px"></asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
