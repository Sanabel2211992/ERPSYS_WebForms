<%@ Page Title="" Language="C#" MasterPageFile="~/ERP/Main.Master" AutoEventWireup="true" CodeBehind="proj-purchase.aspx.cs" Inherits="ERPSYS.ERP.proj.ProjPurchases" %>
...
<asp:Content ID="cMian" ContentPlaceHolderID="cphMain" runat="server">
    <table class="tbl-main">
        ...
        <tr>
            <td>
                <table>
                    <tr>
                        <td class="ft-view">Select Purchases Type : </td>
                        <td class="fv-view">
                            <asp:RadioButtonList ID="rblPurchasesType" runat="server" RepeatDirection="Horizontal" Width="275px" AutoPostBack="true" OnSelectedIndexChanged="rblPurchasesType_SelectedIndexChanged">
                                <asp:ListItem Value="Product" Text="Product" Selected="True" />
                                <asp:ListItem Value="Purchase" Text="Purchase Invoice" />
                            </asp:RadioButtonList>
                        </td>
                    </tr>
                </table>
            ...
            <td>
                <asp:Panel ID="pnlPurchases" runat="server">
                    <fieldset class="fs-edit">
                        <legend class="fs-edit-legend">Purchases Information </legend>
                        <table class="tbl-edit" style="width: 1100px">
                            ...
                            <asp:Panel ID="pnlPurchaseInvoiceSearch" runat="server" Visible="false">
                                <tr>
                                    <td>
                                        <table>
                                            <tr>
                                                <td class="ft-view" style="width: 125px">Purchase Invoice # :</td>
                                                <td class="fv-view" style="width: 300px">
                                                    <telerik:RadSearchBox runat="server" ID="rsbPurchaseInvoice"
                                                        DataKeyNames="PurchaseInvoiceId,InvoiceDate,SupplierName"
                                                        DataTextField="InvoiceNumber"
                                                        DataValueField="PurchaseInvoiceId"
                                                        EnableAutoComplete="true"
                                                        ShowSearchButton="true"
                                                        Filter="StartsWith"
                                                        MaxResultCount="20"
                                                        Width="250px" OnDataSourceSelect="rsbPurchaseInvoice_DataSourceSelect" OnLoad="rsbPurchaseInvoice_Load" OnSearch="rsbPurchaseInvoice_Search">
                                        ...
                                        <asp:Panel ID="pnlPurchaseInvoiceDetails" runat="server" Visible="false">
                                            <table>
                                                <tr>
                                            ...
                                            <div class="grid-container no-bg">
                                                ...
                                                <telerik:RadGrid ID="rgPurchaseInvoice" runat="server" ShowStatusBar="True" AutoGenerateColumns="False" AllowMultiRowSelection="true" ShowFooter="True">
                    ...
                    <tr>
                        <td>
                            <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btn-save" OnClick="btnSave_Click" ValidationGroup="save"
                                OnClientClick="if (typeof(Page_ClientValidate) == 'function') { Page_ClientValidate('save'); if(Page_IsValid) { return confirm('Are you sure you want to save the Purchases ?'); } else return;};" /></td>
                        <td>
    ...
    <telerik:RadAjaxManager ID="raManager" runat="server">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="rblPurchasesType">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="rblPurchasesType" />
                    <telerik:AjaxUpdatedControl ControlID="pnlPurchases" LoadingPanelID="lpLoading" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        </AjaxSettings>
