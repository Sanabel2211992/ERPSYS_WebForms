<%@ Page Title="" Language="C#" MasterPageFile="~/ERP/Main.Master" AutoEventWireup="true" CodeBehind="quote-form.aspx.cs" Inherits="ERPSYS.ERP.lab.QuoteForm" %>
            ...
            <td>
                <telerik:RadToolBar ID="rtbGroupOperations" runat="server" CssClass="tb-main" RenderMode="Lightweight" EnableRoundedCorners="True" EnableShadows="True" SingleClick="None" Width="100%" EnableImageSprites="True" OnButtonClick="rtbGroupOperations_ButtonClick" Skin="Metro">
                    <Items>
                        ...
                        <%--<telerik:RadToolBarButton runat="server" CommandName="arrang" Value="arrang" Text="Products Order" ImageUrl="~/ERP/resources/images/toolbar/ico_group.png" Width="135px" />--%>
                    </Items>
                </telerik:RadToolBar>
            </td>
        </tr>
        <tr>
            <td>
                <table>
                    <tr>
                        <td>
                            <asp:ImageButton ID="imgbtnClose" runat="server" ImageUrl="~/Controls/resources/images/grid/SingleMinus.gif" OnClick="imgbtnClose_Click" />
                        </td>
                        <td>
                            <asp:ImageButton ID="imgbtnOpen" runat="server" ImageUrl="~/Controls/resources/images/grid/SinglePlus.gif" OnClick="imgbtnOpen_Click" />
                        </td>
                    </tr>
                </table>
            </td>
            ...
            <td>
                <div class="grid-container no-bg">
                    ...
                    <telerik:RadGrid ID="rgQuote" runat="server" ShowStatusBar="true" AutoGenerateColumns="False" GridLines="None"
                        ...
                        <MasterTableView HierarchyLoadMode="ServerBind" DataKeyNames="QuoteLineId,LineSeqId,ItemId" Name="MainItem" CommandItemDisplay="Top">
                            <NoRecordsTemplate>
                            ...
                            <DetailTables>
                                <telerik:GridTableView DataKeyNames="ParentId,QuoteLineId,ItemId" Name="SubItems"
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="QuoteLineId" HeaderText="ID" HeaderStyle-Width="45px" />
                                        ...
                                        <telerik:GridTemplateColumn HeaderStyle-Width="20px">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="btnMoveUpS" runat="server" OnClick="btnMoveUpSub_Click" ToolTip="Move Up" ImageUrl="~/Controls/resources/images/grid/Up.png" />
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridTemplateColumn HeaderStyle-Width="20px">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="btnMoveDownS" runat="server" OnClick="btnMoveDownSub_Click" ToolTip="Move Down" ImageUrl="~/Controls/resources/images/grid/Down.png" />
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                            ...
                            <Columns>
                                ...
                                <telerik:GridTemplateColumn HeaderStyle-Width="20px">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="btnMoveUp" runat="server" OnClick="btnMoveUp_Click" ToolTip="Move Up" ImageUrl="~/Controls/resources/images/grid/Up.png" />
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>
                                <telerik:GridTemplateColumn HeaderStyle-Width="20px">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="btnMoveDown" runat="server" OnClick="btnMoveDown_Click" ToolTip="Move Down" ImageUrl="~/Controls/resources/images/grid/Down.png" />
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>
