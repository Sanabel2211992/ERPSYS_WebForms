<%@ Page Title="" Language="C#" MasterPageFile="~/ERP/Main.Master" AutoEventWireup="true" CodeBehind="project-list.aspx.cs" Inherits="ERPSYS.ERP.lab.project_list" %>
                    ...
                    <tr>
                        <td>
                            <telerik:RadGrid ID="rgProjectsList" runat="server" RenderMode="Lightweight" ShowFooter="true" Width="100%" AutoGenerateColumns="False" AllowSorting="True" AllowPaging="True" OnNeedDataSource="rgProject_NeedDataSource" OnInit="rgProject_Init">
                                <MasterTableView ShowHeadersWhenNoRecords="true" DataKeyNames="ProjectId">
                                    <NoRecordsTemplate>
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridTemplateColumn HeaderStyle-Width="16px">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="btnMoveUp" runat="server" OnClick="btnMoveUp_Click" ImageUrl="~/Controls/resources/images/grid/Up.png" />
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridTemplateColumn HeaderStyle-Width="16px">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="btnMoveDown" runat="server" OnClick="btnMoveDown_Click" ImageUrl="~/Controls/resources/images/grid/Down.png" />
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
