<%@ Page Title="" Language="C#" MasterPageFile="~/ERP/Main.Master" AutoEventWireup="true" CodeBehind="modif-order-post.aspx.cs" Inherits="ERPSYS.ERP.man.ModificationOrderPost" %>
    ...
    <script type="text/javascript">
        function onClientButtonClicking(sender, args) {
            ...
            if (button.get_commandName() === "post") {
                args.set_cancel(!confirm("Are you sure you want to post Modification Order ?"));
            }
        }
    </script>
</asp:Content>
            ...
            <td>
                <telerik:RadToolBar ID="rtbOperations" runat="server" CssClass="tb-main" RenderMode="Lightweight" EnableRoundedCorners="True" EnableShadows="True" SingleClick="None" Width="100%" EnableImageSprites="True" OnClientButtonClicking="onClientButtonClicking" OnButtonClick="rtbOperations_ButtonClick" Skin="Metro">
                    <Items>
                        ...
                        <telerik:RadToolBarButton runat="server" CommandName="post" Text="Post Modification order" ImageUrl="~/ERP/resources/images/toolbar/ico_post2.png" Width="180px" />
                    </Items>
                </telerik:RadToolBar>
            </td>
        </tr>
