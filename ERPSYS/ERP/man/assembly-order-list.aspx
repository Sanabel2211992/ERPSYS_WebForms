<%@ Page Title="" Language="C#" MasterPageFile="~/ERP/Main.Master" AutoEventWireup="true" CodeBehind="assembly-order-list.aspx.cs" Inherits="ERPSYS.ERP.man.AssemblyOrderList" %>
...
<asp:Content ID="cMian" ContentPlaceHolderID="cphMain" runat="server">
    ...
    <div class="grid-container no-bg">
        <telerik:RadGrid ID="rgAssemblyOrderList" runat="server" RenderMode="Lightweight" ShowFooter="true" AllowPaging="True" AllowSorting="True"
            AutoGenerateColumns="False" OnNeedDataSource="rgAssemblyOrderList_NeedDataSource" OnItemDataBound="rgAssemblyOrderList_ItemDataBound">
            <MasterTableView ShowHeadersWhenNoRecords="true">
                ...
                <Columns>
                    <telerik:GridBoundColumn DataField="AssemblyOrderId" HeaderText="ID" HeaderStyle-Width="45px" Display="False" />
                    ...
                    <telerik:GridTemplateColumn HeaderStyle-Width="20px">
                        <ItemTemplate>
                            <div>
                                <a href='<%# string.Format("assembly-order-preview.aspx?id={0}", Eval("AssemblyOrderId")) %>'>
                                    <img src="../../Controls/resources/images/ico_search_16_16.gif" alt="Job Order" style="border: 0" />
                                </a>
                            </div>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                    <telerik:GridTemplateColumn HeaderText="Assembly Order #" HeaderStyle-Width="125px">
                        <ItemTemplate>
                            <div>
                                <a class="grdlink" href='<%# string.Format("assembly-order-preview.aspx?id={0}", Eval("AssemblyOrderId")) %>'><%# Eval("AssemblyOrderNumber") %></a>
                            </div>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
    ...
    <telerik:RadAjaxManager ID="raManager" runat="server">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="btnSearch">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="rgAssemblyOrderList" UpdatePanelCssClass="" LoadingPanelID="lpLoading" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="rgAssemblyOrderList">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="rgAssemblyOrderList" UpdatePanelCssClass="" LoadingPanelID="lpLoading" />
                </UpdatedControls>
            </telerik:AjaxSetting>
