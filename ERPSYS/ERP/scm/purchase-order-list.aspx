<%@ Page Title="" Language="C#" MasterPageFile="~/ERP/Main.Master" AutoEventWireup="true" CodeBehind="purchase-order-list.aspx.cs" Inherits="ERPSYS.ERP.scm.PurchaseOrderList" %>
...
<asp:Content ID="cMian" ContentPlaceHolderID="cphMain" runat="server">
    ...
    <div>
        <telerik:RadToolBar ID="rtbOperations" runat="server" CssClass="tb-main" RenderMode="Lightweight" EnableRoundedCorners="True" EnableShadows="True" SingleClick="None" Width="100%" EnableImageSprites="True" OnButtonClick="rtbOperations_ButtonClick" Skin="Metro">
            <Items>
                <telerik:RadToolBarButton runat="server" CommandName="add" Text="New Purchase Order" ImageUrl="~/ERP/resources/images/toolbar/ico_new.png" Width="150px" />
    ...
    <div class="grid-container no-bg">
        <telerik:RadGrid ID="rgPurchaseOrderList" runat="server" RenderMode="Lightweight" ShowFooter="true" AllowPaging="True" AllowSorting="true" Width="100%" AutoGenerateColumns="False"
            OnNeedDataSource="rgPurchaseOrderList_NeedDataSource" OnInit="rgPurchaseOrderList_Init" OnItemDataBound="rgPurchaseOrderList_ItemDataBound">
            <MasterTableView ShowHeadersWhenNoRecords="true">
                ...
                <Columns>
                    <telerik:GridBoundColumn DataField="PurchaseOrderId" HeaderText="ID" HeaderStyle-Width="45px" Visible="False" />
                    ...
                    <telerik:GridTemplateColumn HeaderStyle-Width="20px">
                        <ItemTemplate>
                            <div>
                                <a href='<%# string.Format("purchase-order-preview.aspx?id={0}", Eval("PurchaseOrderId")) %>'>
                    ...
                    <telerik:GridBoundColumn DataField="Total" HeaderText="Total" HeaderStyle-Width="125px" DataFormatString="{0:N}" />
    ...
    <telerik:RadAjaxManager ID="raManager" runat="server">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="btnSearch">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="rgPurchaseOrderList" UpdatePanelCssClass="" LoadingPanelID="lpLoading" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="rgPurchaseOrderList">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="rgPurchaseOrderList" UpdatePanelCssClass="" LoadingPanelID="lpLoading" />
                </UpdatedControls>
            </telerik:AjaxSetting>
