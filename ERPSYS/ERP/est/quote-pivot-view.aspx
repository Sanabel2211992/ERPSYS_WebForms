<%@ Page Title="" Language="C#" MasterPageFile="~/ERP/Main.Master" AutoEventWireup="true" CodeBehind="quote-pivot-view.aspx.cs" Inherits="ERPSYS.ERP.est.QuotePivotView" %>
            ...
            <td>
                <div class="grid-container no-bg">
                    ...
                    <telerik:RadGrid ID="rgSalesQuoteGroupLines" runat="server" ShowFooter="True" Width="1200px" ShowStatusBar="True" GridLines="None"
                        ...
                        <MasterTableView ShowHeadersWhenNoRecords="False" TableLayout="Fixed">
                            <NoRecordsTemplate>
