<%@ Page Title="" Language="C#" MasterPageFile="~/ERP/Main.Master" AutoEventWireup="true" CodeBehind="quote-report.aspx.cs" Inherits="ERPSYS.ERP.est.QuoteReport" %>
                ...
                <tr>
                    ...
                    <td class="field-val">
                        <asp:RadioButtonList ID="rblReportView" runat="server" AutoPostBack="True" OnSelectedIndexChanged="rblReportView_SelectedIndexChanged" RepeatDirection="Horizontal" Width="225px">
                            <asp:ListItem Selected="True" Value="Combined">Details View</asp:ListItem>
