...
{
    public partial class QuotePivotView : System.Web.UI.Page
    {
        ...
        protected void rgSalesQuoteGroupLines_ColumnCreated(object sender, GridColumnCreatedEventArgs e)
        {
            switch (e.Column.UniqueName)
            {
                ...
                case "Description":
                    ...
                    e.Column.HeaderStyle.Width = System.Web.UI.WebControls.Unit.Pixel(450);
                    break;
                case "TotalQty":
        ...
        protected void rgSalesQuoteGroupLines_ItemDataBound(object sender, GridItemEventArgs e)
        {
            if (rgSalesQuoteGroupLines.MasterTableView.Items.Count > 0)
            {
                ...
                else if (e.Item is GridFooterItem)
                {
                    ...
                    footer.Cells[4].Text = TotalQty.ToDecimalFormat(2);
                    footer.Cells[5].Text = NetPrice.ToDecimalFormat(2);
                    footer.Cells[6].Text = TotalPrice.ToDecimalFormat(2);
                }
            }
        }
