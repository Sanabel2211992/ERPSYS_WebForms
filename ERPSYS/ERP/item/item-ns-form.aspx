<%@ Page Title="" Language="C#" MasterPageFile="~/ERP/Main.Master" AutoEventWireup="true" CodeBehind="item-ns-form.aspx.cs" Inherits="ERPSYS.ERP.item.ItemNonStandardForm" %>
                ...
                <fieldset class="fs-edit">
                    ...
                    <table class="tbl-edit" style="width: 945px">
                        ...
                        <tr>
                            ...
                            <td class="fv-edit">
                                <asp:DropDownList ID="ddlItemType" runat="server" Width="158px" Enabled="false">
                                </asp:DropDownList>
                            </td>
                            <td class="ft-edit">Additional Code :</td>
                            <td class="fv-edit">
                                <asp:TextBox ID="txtAdditionalCode" runat="server" Width="158px" Enabled="false"></asp:TextBox>
                            </td>
                            <td class="ft-edit" colspan="2">
                                <asp:CheckBox ID="cbIsNonStandard" runat="server" Text="Non Standard Product" Checked="true" Enabled="false" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="fv-edit">
                                <b>NS</b>
                                <asp:TextBox ID="txtItemCode" runat="server" Width="130px"></asp:TextBox>
                            ...
                            <td class="fv-edit">
                                <b>NS</b>
                                <asp:TextBox ID="txtPartNumber" runat="server" Width="140px"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="rfvtxtPartNumber" runat="server" ControlToValidate="txtPartNumber"
                                    ErrorMessage="*" CssClass="val-error" Display="Dynamic" SetFocusOnError="True"></asp:RequiredFieldValidator>
                            </td>
                            <td class="ft-edit">
                                <asp:CheckBox ID="cbBeSold" runat="server" Text="Can be Sold" Checked="true" Enabled="false" />
                            </td>
                            <td class="fv-edit">&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td class="ft-edit">
                                <asp:CheckBox ID="cbManufacture" runat="server" Text="Manufacture" Checked="true" Enabled="false" />
                            </td>
                            <td class="fv-edit">&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td class="ft-edit">
                                <asp:CheckBox ID="cbHasBom" runat="server" Text="Enable BOM" Checked="true" Enabled="false" />
                            </td>
                            <td class="fv-edit">&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td class="ft-edit">
                                <asp:CheckBox ID="cbIsActive" runat="server" Text="Active" Checked="True" Enabled="false" />
                            </td>
                            <td class="fv-edit">&nbsp;</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="fv-edit">
                                <asp:DropDownList ID="ddlUom" runat="server" Width="150px" Enabled="false">
                                </asp:DropDownList>
