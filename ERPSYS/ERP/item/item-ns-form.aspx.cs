...
{
    public partial class ItemNonStandardForm : System.Web.UI.Page
    {
        ...
        protected void GetItemLookupTables()
        {
            ...
            ddlCategory.DataSource = lookup.GetItemManufactureCategory();
            ...
            ddlBrand.DataSource = lookup.GetItemManufactureBrand();
            ddlBrand.DataBind();
        ...
        protected void InitializeForm()
        {
            ...
            //ddlCategory.SelectedValue = 11.ToString();
            //ddlBrand.SelectedValue = 10.ToString();
            ddlUom.SelectedValue = 10.ToString();
        ...
        protected void AddItemAdvanced()
        {
            ...
            item.ItemCode = "NS" + txtItemCode.Text.ToTrimString();
            item.PartNumber = "NS" + txtPartNumber.Text.ToTrimString();
