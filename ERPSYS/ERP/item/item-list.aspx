<%@ Page Title="" Language="C#" MasterPageFile="~/ERP/Main.Master" AutoEventWireup="true" CodeBehind="item-list.aspx.cs" Inherits="ERPSYS.ERP.item.ItemList" %>
...
<asp:Content ID="cHeader" ContentPlaceHolderID="cphHeader" runat="server">
    <script type="text/javascript">
        function ClearFields() {
            ...
            $('#<%= cbIsManufacture.ClientID %>').removeAttr('checked');
            $('#<%= cbIsNonStandard.ClientID %>').removeAttr('checked');
        }
    </script>
</asp:Content>
<asp:Content ID="cMian" ContentPlaceHolderID="cphMain" runat="server">
                    ...
                    <table class="tbl-search" style="width: 1180px">
                        ...
                        <tr>
                            ...
                            <td class="ft-search" colspan="2">
                                <asp:CheckBox ID="cbIsManufacture" runat="server" Text="Manufacturing Only" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="ft-search" colspan="2">
                                <asp:CheckBox ID="cbIsNonStandard" runat="server" Text="Non Standard Only" />
                            </td>
                        </tr>
                        <tr>
    ...
    <div>
        <telerik:RadToolBar ID="rtbOperations" runat="server" CssClass="tb-main" RenderMode="Lightweight" EnableRoundedCorners="True" EnableShadows="True" SingleClick="None" Width="100%" EnableImageSprites="True" OnButtonClick="rtbOperations_ButtonClick" Skin="Metro">
            <Items>
                <telerik:RadToolBarButton runat="server" CommandName="add" Text="Add Product" ImageUrl="~/ERP/resources/images/toolbar/ico_new.png" Width="110px" />
        ...
        <telerik:RadGrid ID="rgItemList" runat="server" RenderMode="Lightweight" ShowFooter="true" AllowPaging="True" AllowSorting="True" Width="100%" AutoGenerateColumns="False" OnNeedDataSource="rgItemList_NeedDataSource" OnInit="rgItemList_Init" OnItemDataBound="rgItemList_ItemDataBound">
            <MasterTableView ShowHeadersWhenNoRecords="true">
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn UniqueName="Edit" HeaderStyle-Width="16px">
                        <ItemTemplate>
                            <div>
                                <a href='<%# string.Format("item-form.aspx?o=edit&id={0}", Eval("ItemId")) %>'>
