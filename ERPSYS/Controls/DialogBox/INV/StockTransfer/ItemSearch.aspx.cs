...
namespace ERPSYS.Controls.DialogBox.INV.StockTransfer
{
    public partial class ItemSearch : System.Web.UI.Page
    {
        ...
        protected void GetData()
        {
            try
            {
                rgItems.DataSource = _item.GetStockTransferItemDialog(ItemCode, PartNumber, Description, ShowAvailableOnly);
            }
            catch (Exception ex)
            {
