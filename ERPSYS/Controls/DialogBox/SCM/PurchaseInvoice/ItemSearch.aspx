<%@ Page Title="" Language="C#" MasterPageFile="~/Controls/DialogBox/Dialog.Master" AutoEventWireup="true" CodeBehind="ItemSearch.aspx.cs" Inherits="ERPSYS.Controls.DialogBox.SCM.PurchaseInvoice.ItemSearch" %>
    ...
    <telerik:RadCodeBlock runat="server" ID="rdbScripts">
        <script type="text/javascript">
            ...
            function RowSelected() {
                ...
                oArg.uomid = master.getCellByColumnUniqueName(row, "UomId").innerHTML;
