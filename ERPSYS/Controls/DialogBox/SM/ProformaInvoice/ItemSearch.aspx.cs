...
namespace ERPSYS.Controls.DialogBox.SM.ProformaInvoice
{
    public partial class ItemSearch : System.Web.UI.Page
    {
        ...
        protected void GetData()
        {
            try
            {
                rgItems.DataSource = _item.GetProformaInvoiceItemDialog(ItemCode, PartNumber, Description, ShowAvailableOnly);
            }
            catch (Exception ex)
            {
