...
namespace ERPSYS.Controls.DialogBox.SM.SalesInvoice
{
    public partial class ItemSearch : System.Web.UI.Page
    {
        ...
        protected void GetData()
        {
            try
            {
                rgItems.DataSource = _item.GetSalesInvoiceItemDialog(ItemCode, PartNumber, Description, ShowAvailableOnly);
            }
            catch (Exception ex)
            {
