<%@ Page Title="" Language="C#" MasterPageFile="~/Controls/DialogBox/Dialog.Master" AutoEventWireup="true" CodeBehind="ItemSearch.aspx.cs" Inherits="ERPSYS.Controls.DialogBox.SM.SalesInvoice.ItemSearch" %>
    ...
    <telerik:RadCodeBlock runat="server" ID="rdbScripts">
        <script type="text/javascript">
            ...
            function RowSelected() {
                ...
                oArg.price = master.getCellByColumnUniqueName(row, "UnitPrice").innerHTML;
                oArg.minprice = master.getCellByColumnUniqueName(row, "MinPrice").innerHTML;
                oArg.stockqty = master.getCellByColumnUniqueName(row, "StockQuantity").innerHTML;
                            ...
                            <telerik:RadGrid ID="rgItems" runat="server" ShowFooter="true" AutoGenerateColumns="False" AllowPaging="True" PageSize="35" Width="800px" Height="435px"
                                ...
                                <MasterTableView DataKeyNames="ItemId" TableLayout="Fixed" ShowHeadersWhenNoRecords="true">
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="MinPrice" Display="false" />
                                        ...
                                        <telerik:GridBoundColumn DataField="UnitPrice" HeaderText="Price" HeaderStyle-Width="50px" DataFormatString="{0:F2}" />
                                        <telerik:GridBoundColumn DataField="StockQuantity" HeaderText="QTY" HeaderStyle-Width="50px" DataFormatString="{0:F0}" />
                                    </Columns>
                                </MasterTableView>
                                <ClientSettings>
