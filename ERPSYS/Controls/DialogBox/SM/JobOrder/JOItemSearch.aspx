<%@ Page Title="" Language="C#" MasterPageFile="~/Controls/DialogBox/Dialog.Master" AutoEventWireup="true" CodeBehind="JOItemSearch.aspx.cs" Inherits="ERPSYS.Controls.DialogBox.SM.JobOrder.JOItemSearch" %>
                            ...
                            <telerik:RadGrid ID="rgItems" runat="server" ShowFooter="true" AutoGenerateColumns="False" AllowPaging="True" PageSize="35" Width="800px" Height="435px"
                                ...
                                <MasterTableView DataKeyNames="ItemId" TableLayout="Fixed" ShowHeadersWhenNoRecords="true">
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="JOQuantity" HeaderText="Quantity" HeaderStyle-Width="100px" DataFormatString="{0:F0}" />
                                    </Columns>
                                </MasterTableView>
                                <ClientSettings>
