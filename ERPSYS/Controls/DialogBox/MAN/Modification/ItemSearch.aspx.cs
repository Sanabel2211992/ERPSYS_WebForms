...
namespace ERPSYS.Controls.DialogBox.MAN.Modification
{
    public partial class ItemSearch : System.Web.UI.Page
    {
        ...
        protected void GetData()
        {
            try
            {
                rgItems.DataSource = _item.GetModificationOrderRawMaterialItemDialog(ItemCode, PartNumber, Description);
            }
            catch (Exception ex)
            {
