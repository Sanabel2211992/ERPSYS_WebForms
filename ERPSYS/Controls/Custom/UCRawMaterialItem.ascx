<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCRawMaterialItem.ascx.cs" Inherits="ERPSYS.Controls.Custom.UCRawMaterialItem" %>
    ...
    <fieldset class="fs-inner">
        ...
        <table class="tbl-ucsearch" style="width: 600px">
            ...
            <tr>
                ...
                <td class="uc-field-val" colspan="3">
                    <telerik:RadSearchBox runat="server" ID="rsbItem"
                        DataKeyNames="ItemCode,PartNumber,Name,Description,Category,SubCategory,UOM,AvailableQuantity"
            ...
            <tr>
                ...
                <td class="uc-field-title">Stock Quantity</td>
                <td class="uc-field-val read-only">
