<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCItemAdd.ascx.cs" Inherits="ERPSYS.Controls.HierarchyItems.Production.Assembly.UCItemAdd" %>
...
<telerik:RadAjaxPanel runat="server" ID="rapItem" LoadingPanelID="lpLoading">
    <table class="tbl-uc-gedit" style="width: 100%">
        <tr>
        ...
        <tr>
            ...
            <td class="fv-gedit">
                <telerik:RadNumericTextBox ID="txtItemQuantity" runat="server" MaxValue="999999" MinValue="1" Width="150px">
