<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSubItemAdd.ascx.cs" Inherits="ERPSYS.Controls.HierarchyItems.EST.Quote.UCSubItemAdd" %>
        ...
        <tr>
            ...
            <td class="fv-gedit" colspan="5" style="position: relative">
                ...
                <div class="img-search">
                    <img alt="catalog" title="Advance Search" width="16" height="16" runat="server" src="~/Controls/resources/images/ico_item_16.gif" onclick="OpenDialogSearchS(); return false;" />
                </div>
                <div class="img-clear">
                    <img alt="clear" title="Clear Fields" width="16" height="16" runat="server" src="~/Controls/resources/images/ico_clear_16_16.png" onclick="ClearAllFieldsS(); return false;" />
                </div>
            </td>
        </tr>
        <tr>
...
<telerik:RadWindowManager ID="rwmItem" ShowContentDuringLoad="false" RenderMode="Lightweight" VisibleStatusbar="false" ReloadOnShow="true" runat="server">
    <Windows>
        <telerik:RadWindow ID="rwItemSearch" RenderMode="Lightweight" runat="server" Modal="True"
            AutoSize="False" Width="835px" Height="550px" MaxWidth="835px" MaxHeight="550" OnClientClose="OnItemSearchCloseS"
