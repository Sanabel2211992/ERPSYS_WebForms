<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCMainItemAdd.ascx.cs" Inherits="ERPSYS.Controls.HierarchyItems.EST.Quote.UCMainItemAdd" %>
...
<telerik:RadScriptBlock runat="server" ID="rdbScripts">
    <script type="text/javascript">
        ...
        function OnItemCloseM(oWnd, args) {
    ...
    <table class="tbl-uc-gedit" style="width: 900px">
        ...
        <tr>
            ...
            <td class="fv-gedit" colspan="3">
                <asp:RadioButtonList ID="rblMainItemType" runat="server" AutoPostBack="True" OnSelectedIndexChanged="rblMainItemType_SelectedIndexChanged" RepeatDirection="Horizontal" Width="300px">
                    <asp:ListItem Selected="True" Value="Single">Product</asp:ListItem>
                    <asp:ListItem Value="Group">Group of Products ( ex: Panel )</asp:ListItem>
                </asp:RadioButtonList>
            </td>
            ...
            <tr>
                ...
                <td class="fv-gedit" style="position: relative" colspan="5">
                    ...
                    <div style="position: absolute; left: 660px; top: 5px">
                        <img alt="catalog" width="16" height="16" runat="server" src="~/Controls/resources/images/ico_item_16.gif" onclick="OpenDialogM(); return false;" />
                    </div>
                    <div style="position: absolute; left: 682px; top: 5px">
                        <img alt="clear" width="16" height="16" runat="server" src="~/Controls/resources/images/ico_clear_16_16.png" onclick="ClearFieldsM(); return false;" />
                    </div>
                </td>
            </tr>
            <tr>
        ...
        <asp:Panel ID="pnlGroup" runat="server" Visible="False">
            <tr>
                <td class="ft-gedit">Description :</td>
                <td class="fv-gedit" colspan="5">
                    <asp:TextBox ID="txtGroupItemDescription" runat="server" Width="645px"></asp:TextBox>
            ...
            <tr>
                ...
                <td class="fv-gedit" colspan="4">
                    <asp:CheckBox ID="cbEnableRoundUp" runat="server" ForeColor="Maroon" Text="Enable Round Up Group Price" />
                </td>
                <td class="ft-gedit"></td>
                <td class="fv-gedit"></td>
                <td class="ft-gedit"></td>
...
<div class="d-grid-op">
    <div class="sm-so-ma-p">
        <asp:Button ID="btnSave" runat="server" Text="Save" ValidationGroup="addMainItem" CssClass="btn-Add-edit" CommandName="PerformInsert" />&nbsp;
...
<telerik:RadWindowManager ID="rwmItem" ShowContentDuringLoad="false" RenderMode="Lightweight" VisibleStatusbar="false" ReloadOnShow="true" runat="server">
    <Windows>
        <telerik:RadWindow ID="rwItemSearch" runat="server" Modal="True" RenderMode="Lightweight"
            AutoSize="False" Width="835px" Height="550px" MaxWidth="835px" MaxHeight="550" OnClientClose="OnItemCloseM"
