<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSubItemReplace.ascx.cs" Inherits="ERPSYS.Controls.HierarchyItems.EST.Quote.UCSubItemReplace" %>
...
<telerik:RadAjaxPanel runat="server" ID="rapItem" LoadingPanelID="RadAjaxLoadingPanel">
    <table class="tbl-uc-gedit" style="width: 900px">
        ...
        <tr>
            ...
            <td colspan="5">
                <asp:CustomValidator ID="cvItem0" runat="server" OnServerValidate="cvItem_ServerValidate" CssClass="val-error" Display="Dynamic" ValidationGroup="addItem" ErrorMessage="Please select a valid product !!"></asp:CustomValidator>
            </td>
            <tr>
        ...
        <tr>
            ...
            <td class="fv-gedit" colspan="5" style="position: relative">
                <telerik:RadSearchBox ID="rsbItem" runat="server" DataKeyNames="ItemCode,PartNumber,Description,UnitPrice,StockQuantity"
                    DataTextField="DisplayName" DataValueField="ItemId" EnableAutoComplete="true" Filter="StartsWith" MaxResultCount="20"
                    OnDataSourceSelect="rsbItem_DataSourceSelect" OnLoad="rsbItem_Load" OnSearch="rsbItem_Search"
                    ShowSearchButton="true" Width="680px">
                    <DropDownSettings Width="680px" />
                </telerik:RadSearchBox>
                <asp:HiddenField ID="hfItemID" runat="server" />
                <div class="img-search">
                    <img alt="catalog" title="Advance Search" width="16" height="16" runat="server" src="~/Controls/resources/images/ico_item_16.gif" onclick="OpenDialogR(); return false;" />
                </div>
                <div class="img-clear">
                    <img alt="clear" title="Clear Fields" width="16" height="16" runat="server" src="~/Controls/resources/images/ico_clear_16_16.png" onclick="ClearFieldsR(); return false;" />
                </div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="fv-gedit" colspan="5">
                <asp:TextBox ID="txtItemDescriptionAs" runat="server" Width="680px"></asp:TextBox>
...
<telerik:RadWindowManager ID="rwmItem" ShowContentDuringLoad="false" VisibleStatusbar="false" ReloadOnShow="true" runat="server">
    <Windows>
        <telerik:RadWindow ID="rwItemSearch" RenderMode="Lightweight" runat="server" Modal="True"
            AutoSize="False" Width="835px" Height="550px" MaxWidth="835px" MaxHeight="550" OnClientClose="OnItemCloseR"
...
<table class="tbl-uc" style="width: 600px">
    <tr>
