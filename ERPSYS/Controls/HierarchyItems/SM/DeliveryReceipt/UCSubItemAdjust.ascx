<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSubItemAdjust.ascx.cs" Inherits="ERPSYS.Controls.HierarchyItems.SM.DeliveryReceipt.UCSubItemAdjust" %>
