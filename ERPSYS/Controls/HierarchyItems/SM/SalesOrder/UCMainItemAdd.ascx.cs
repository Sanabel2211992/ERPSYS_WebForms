...
namespace ERPSYS.Controls.HierarchyItems.SM.SalesOrder
{
    public partial class UCMainItemAdd : System.Web.UI.UserControl
    {
        ...
        protected void rsbItem_DataSourceSelect(object sender, SearchBoxDataSourceSelectEventArgs e)
        {
            ...
            rsbItem.DataSource = _item.GetSalesOrderItemSearchBox(typeId, categoryId, subCategoryId, brandId, search);
        }
