<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCMainItemAdd.ascx.cs" Inherits="ERPSYS.Controls.HierarchyItems.SM.SalesOrder.UCMainItemAdd" %>
...
<telerik:RadScriptBlock runat="server" ID="rdbScripts">
    <script type="text/javascript">
        ...
        function OpenDialog() {
            ...
            manager.open("../../Controls/DialogBox/SM/SalesOrder/ItemSearch.aspx", "rwItemSearch");
        }
