<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSubItemAdd.ascx.cs" Inherits="ERPSYS.Controls.HierarchyItems.SM.SalesOrder.UCSubItemAdd" %>
...
<telerik:RadWindowManager ID="rwmItem" ShowContentDuringLoad="false" VisibleStatusbar="false" ReloadOnShow="true" runat="server" RenderMode="Lightweight">
    <Windows>
