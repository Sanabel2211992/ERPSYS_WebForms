<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSubItemAdd.ascx.cs" Inherits="ERPSYS.Controls.HierarchyItems.SM.SalesInvoice.UCSubItemAdd" %>
            ...
            <td colspan="5">
                <table style="width: 700px">
                    ...
                    <tr>
                        ...
                        <td class="fv-gedit">
                            <asp:DropDownList ID="ddlItemCategory" runat="server" AutoPostBack="True" Width="150px">
                            </asp:DropDownList></td>
                        <td class="fv-gedit">
                            <asp:DropDownList ID="ddlBrand" runat="server" AutoPostBack="True" Width="150px">
                            </asp:DropDownList></td>
                        <td class="fv-gedit">
                            <asp:CheckBox ID="cbAvailableOnly" runat="server" Text="Only available Products in stock" />
                        </td>
                    </tr>
                </table>
            </td>
...
<table class="tbl-ucsearch" style="width: 700px">
    <tr>
        ...
        <td style="width: 175px" class="relative">
            <asp:Button ID="btnSave" runat="server" Text="Save" ValidationGroup="addItem" CssClass="s-add-save btn-Add-edit" CommandName="PerformInsert" />&nbsp;
