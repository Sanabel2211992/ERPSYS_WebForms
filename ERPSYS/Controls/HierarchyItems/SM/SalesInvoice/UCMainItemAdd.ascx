<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCMainItemAdd.ascx.cs" Inherits="ERPSYS.Controls.HierarchyItems.SM.SalesInvoice.UCMainItemAdd" %>
    ...
    <telerik:RadScriptBlock runat="server" ID="rdbScripts">
        <script type="text/javascript">
            ...
            function OpenDialog() {
                ...
                manager.open("../../Controls/DialogBox/SM/SalesInvoice/ItemSearch.aspx", "rwItemSearch");
            }
            ...
            function OnItemClose(oWnd, args) {
                ...
                if (arg) {
                    ...
                    $('#<%= hfMinPrice.ClientID %>').val(minprice);
        ...
        <asp:Panel ID="pnlSingle" runat="server" Visible="True">
                ...
                <td colspan="5">
                    <table style="width: 700px">
                        <tr>
                            ...
                            <td class="ft-gedit" style="width: 175px"></td>
                        </tr>
                        <tr>
                            <td class="fv-gedit">
                                <asp:DropDownList ID="ddlItemType" AutoPostBack="true" runat="server" Width="150px">
                                </asp:DropDownList></td>
                            <td class="fv-gedit">
                                <asp:DropDownList ID="ddlItemCategory" AutoPostBack="true" runat="server" Width="150px">
                                </asp:DropDownList></td>
                            <td class="fv-gedit">
                                <asp:DropDownList ID="ddlBrand" AutoPostBack="true" runat="server" Width="150px">
                                </asp:DropDownList></td>
                            <td class="fv-gedit">
                                <asp:CheckBox ID="cbAvailableOnly" AutoPostBack="true" runat="server" Text="Only available Products in stock" />
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                ...
                <td class="fv-gedit" style="position: relative" colspan="5">
                    <telerik:RadSearchBox runat="server" ID="rsbItem"
                        DataKeyNames="ItemCode,PartNumber,Name,Description,UnitPrice,StockQuantity,MinPrice"
                    ...
                    <asp:HiddenField ID="hfMinPrice" runat="server" />
            ...
            <tr>
                ...
                <td class="fv-gedit read-only" colspan="5">
                    <asp:TextBox ID="txtItemDescription" runat="server" ReadOnly="True" Width="650px"></asp:TextBox>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="fv-gedit" colspan="5">
                    <asp:TextBox ID="txtItemDescriptionAs" runat="server" Width="650px"></asp:TextBox>
            ...
            <tr>
                ...
                <td class="fv-gedit" style="width: 175px">
                    <asp:CheckBox ID="cbSpecialItem" runat="server" OnCheckedChanged="cbSpecialItem_CheckedChanged" AutoPostBack="True" Text="Consider As Special Product" /></td>
                <td class="ft-gedit"></td>
                <td class="fv-gedit"></td>
