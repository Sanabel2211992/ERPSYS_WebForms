<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCItemAdd.ascx.cs" Inherits="ERPSYS.Controls.HierarchyItems.SCM.PurchaseOrder.UCItemAdd" %>
...
<telerik:RadScriptBlock runat="server" ID="rdbScripts">
    <script type="text/javascript">
        ...
        function OpenDialog() {
            ...
            manager.open("../../Controls/DialogBox/SCM/PurchaseOrder/ItemSearch.aspx", "rwItemSearch");
        }
