<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCItemEdit.ascx.cs" Inherits="ERPSYS.Controls.HierarchyItems.SCM.PurchaseInvoice.UCItemEdit" %>
...
<table class="tbl-uc-gedit" style="width: 600px">
    ...
    <tr>
        <td class="ft-gedit" colspan="3">&nbsp;</td>
        <td class="relative">
