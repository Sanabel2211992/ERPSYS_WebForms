<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCItemAdd.ascx.cs" Inherits="ERPSYS.Controls.HierarchyItems.PROJ.UCItemAdd" %>
...
<telerik:RadScriptBlock runat="server" ID="rdbScripts">
    <script type="text/javascript">
       ...
       <%-- function OpenDialog() {
            ...
            manager.open("../../Controls/DialogBox/PROJ/ItemSearch.aspx", "rwItemSearch");
        }
