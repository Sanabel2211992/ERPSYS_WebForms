<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCInputItemEdit.ascx.cs" Inherits="ERPSYS.Controls.HierarchyItems.MAN.Modification.UCInputItemEdit" %>
...
<table class="tbl-uc-gedit" style="width: 900px">
    ...
    <tr>
        ...
        <td class="fv-gedit" colspan="5">
            <asp:Label ID="lblItemDescription" runat="server" Text='<%# Bind("InputDescription")%>'></asp:Label>
        </td>
    </tr>
    <tr>
        <td class="ft-gedit">Quantity :</td>
        <td class="fv-gedit">
            <telerik:RadNumericTextBox ID="txtQuantity" runat="server" Text='<%# Bind("InputQuantity") %>' Width="65px" MinValue="1" MaxValue="999999">
...
<asp:HiddenField ID="hfItemID" Value='<%# Bind("InputItemId") %>' runat="server" />
