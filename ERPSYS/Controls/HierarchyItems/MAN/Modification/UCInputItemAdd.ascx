<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCInputItemAdd.ascx.cs" Inherits="ERPSYS.Controls.HierarchyItems.MAN.Modification.UCInputItemAdd" %>
...
<telerik:RadScriptBlock runat="server" ID="RadScriptBlock1">
    <script type="text/javascript">
        ...
        function OpenDialog() {
            ...
            manager.open("../../Controls/DialogBox/SM/JobOrder/JOItemSearch.aspx?id=<%=JobOrderId %>", "rwItemSearch");
        }
...
<telerik:RadAjaxPanel runat="server" ID="RadAjaxPanel1" LoadingPanelID="lpLoading">
    <table class="tbl-uc-gedit" style="width: 900px">
        ...
        <tr>
            <th></th>
            <th colspan="5">
                <asp:CustomValidator ID="cvItem" runat="server" ValidationGroup="save" ClientValidationFunction="Validate" CssClass="val-error" Display="Dynamic" ErrorMessage="Please select a valid Product !!"></asp:CustomValidator>
            </th>
        </tr>
        <tr>
            ...
            <td class="fv-gedit" colspan="5" style="position: relative">
                <telerik:RadSearchBox runat="server" ID="rsbItem"
                    DataKeyNames="ItemCode,PartNumber,Name,Description,StockQuantity"
                ...
                <asp:HiddenField ID="hfJoID" runat="server" />
...
<telerik:RadWindowManager ID="rwManager" runat="server" ShowContentDuringLoad="false" ReloadOnShow="true" RenderMode="Lightweight" Behaviors="Move, Close" VisibleStatusbar="false" Modal="true">
    <Windows>
        <telerik:RadWindow ID="rwItemSearch" runat="server" Title="Job Order Product Search" Width="800px" Height="544px" OnClientClose="OnItemClose" />
