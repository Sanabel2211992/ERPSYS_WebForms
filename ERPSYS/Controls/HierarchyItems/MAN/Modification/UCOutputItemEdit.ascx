<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCOutputItemEdit.ascx.cs" Inherits="ERPSYS.Controls.HierarchyItems.MAN.Modification.UCOutputItemEdit" %>
...
<table class="tbl-uc-gedit" style="width: 900px">
    ...
    <tr>
        ...
        <td class="fv-gedit" colspan="5">
            <asp:Label ID="lblItemDescription" runat="server" Text='<%# Bind("OutputDescription")%>'></asp:Label>
        </td>
    </tr>
    <tr>
        <td class="ft-gedit">Quantity :</td>
        <td class="fv-gedit">
            <telerik:RadNumericTextBox ID="txtQuantity" runat="server" Text='<%# Bind("OutputQuantity") %>' Width="65px" MinValue="1" MaxValue="999999">
...
<asp:HiddenField ID="hfItemID" Value='<%# Bind("OutputItemId") %>' runat="server" />
