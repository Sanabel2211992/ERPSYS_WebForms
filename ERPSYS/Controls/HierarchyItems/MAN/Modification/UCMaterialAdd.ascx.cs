...
{
    public partial class UCMaterialAdd : System.Web.UI.UserControl
    {
        ...
        protected void rsbItem_DataSourceSelect(object sender, SearchBoxDataSourceSelectEventArgs e)
        {
            ...
            rsbItem.DataSource = _item.GetModificationItemMaterialSearchBox(typeId, categoryId, subCategoryId, brandId, search);
        }
