<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCRMItemAdd.ascx.cs" Inherits="ERPSYS.Controls.HierarchyItems.MAN.Production.UCRMItemAdd" %>
...
<telerik:RadScriptBlock runat="server" ID="rdbScripts">
    <script type="text/javascript">
        ...
        function OpenDialog() {
            ...
            manager.open("../../Controls/DialogBox/MAN/Production/ItemSearch.aspx", "rwItemSearch");
        }
...
<telerik:RadAjaxPanel runat="server" ID="rapItem" LoadingPanelID="RadAjaxLoadingPanel">
    <table class="tbl-uc-gedit" style="width: 900px">
        ...
        <tr>
            <td class="fv-gedit">Product Search :</td>
        ...
        <tr>
            <td class="fv-gedit">Description :</td>
